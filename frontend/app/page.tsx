...
import { Users, Car, Wrench, Calendar, Sparkles, ArrowRight } from 'lucide-react';
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100/50 pb-20 lg:pb-4">
        ...
        <main className="container mx-auto px-6 max-w-6xl mt-8 space-y-10">
                ...
                return (
                  ...
                  >
                    <ModernCard className="overflow-hidden relative">
                      ...
                      <div className={`absolute inset-0 ${stat.lightBg} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                      ...
                      <ModernCardHeader className="pb-4 relative">
                        <div className="flex items-start justify-between">
                          <div className="space-y-2">
                            ...
                            <p className="text-4xl font-outfit font-bold text-gray-900 tracking-tight">
                              {loading ? '...' : stat.value}
                            </p>
                          </div>
                          <div className={`relative p-2.5 ${stat.iconBg} rounded-lg shadow-soft transition-transform duration-300 group-hover:scale-110 group-hover:shadow-medium`}>
          ...
          {/* Quick Actions with better interaction */}
          <div>
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">
              Acesso Rápido
            </h2>
            <div className="grid gap-4 md:grid-cols-2">
              {quickActions.map((nav, index) => {
                ...
                return (
                  ...
                  >
                    <ModernCard className={`cursor-pointer transition-all duration-300 ${nav.hoverGlow}`}>
                      <ModernCardHeader>
                        <div className="flex items-center gap-4">
                          <div className={`relative p-3 bg-gradient-to-br ${nav.gradient} rounded-xl shadow-soft transition-all duration-300 group-hover:scale-105 group-hover:shadow-medium`}>
                            <Icon className="w-6 h-6 text-white" />
                          </div>
                          <div className="flex-1">
                            <ModernCardTitle className="text-lg mb-1.5 font-outfit">
                              {nav.title}
                            </ModernCardTitle>
                          ...
                          <ArrowRight className="w-5 h-5 text-gray-400 transition-all duration-300 group-hover:text-gray-600 group-hover:translate-x-1" />
                        </div>
                      </ModernCardHeader>
                    </ModernCard>
                  </Link>
